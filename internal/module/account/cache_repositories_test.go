...
func (m *MockRedisService) GetSet(ctx context.Context, key string, value interface{}) (string, error) {
	return "", nil
}
func (m *MockRedisService) HSet(ctx context.Context, key, field string, value interface{}) error {
	return nil
}
func (m *MockRedisService) HGet(ctx context.Context, key, field string) (string, error) {
	return "", nil
}
func (m *MockRedisService) HGetAll(ctx context.Context, key string) (map[string]string, error) {
	return nil, nil
}
func (m *MockRedisService) HDelete(ctx context.Context, key string, fields ...string) (int64, error) {
	return 0, nil
}
func (m *MockRedisService) HExists(ctx context.Context, key, field string) (bool, error) {
	return false, nil
}
func (m *MockRedisService) LPush(ctx context.Context, key string, values ...interface{}) (int64, error) {
	return 0, nil
}
func (m *MockRedisService) RPush(ctx context.Context, key string, values ...interface{}) (int64, error) {
	return 0, nil
}
...
func (m *MockRedisService) LRange(ctx context.Context, key string, start, stop int64) ([]string, error) {
	return nil, nil
}
...
func (m *MockRedisService) Info(ctx context.Context, section ...string) (string, error) {
	return "", nil
}
...
func TestCacheSessionRepository_GetSessionByToken(t *testing.T) {
	...
	mockRedis.On("Get", mock.Anything, "session_last_used:test_token_hash").Return("1640995200", nil)
